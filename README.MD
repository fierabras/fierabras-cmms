...
| LICENSE_KEY                 | No       | Legacy cloud setting; it is not used by the self-hosted AGPLv3 fork.                                                                                                                                                                                                                                               | (empty)               |
...
| LOGO_PATHS                  | No       | Logo names in this format. `{"dark": "dark.png","white": "white.png", }`. Add 2 logos in a folder named `logo` in the same folder as the `docker-compose.yml`.                                                                                                                                                  | (empty)               |
...
| BRAND_CONFIG                | No       | Brand config for white labeling. In format `{ "name": "Quantum Labs", "shortName": "QL", "website": "https://example.io", mail: "contact@example.io" }`                                                                                                                                                         | (empty)               |
...
Fierabrás CMMS is distributed exclusively under the
...
- All commercial license restrictions are removed by a local AGPL policy; the
  self-hosted fork does not require an external license or purchase.
...
- Original copyright, trademark, and attribution notices are retained; this
  fork adopts **only** AGPL-3.0-only.
